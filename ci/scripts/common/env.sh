...
export MODEL_PATH="${MODEL_PATH:-/ssd3/models/Qwen3-VL-30B-A3B-Instruct}"
export SERVED_MODEL_NAME="${SERVED_MODEL_NAME:-Qwen3-VL-30B-A3B-Instruct}"
...
export WORKSPACE_MOUNT="${WORKSPACE_MOUNT:-/home/users/v_huchenchao/workspace:/workspace}"
